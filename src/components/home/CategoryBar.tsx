...
export function CategoryBar({ 
  ...
  return (
    <div className="sticky top-0 z-40 bg-white/95 backdrop-blur-sm border-b border-neutral-100 pt-2 md:pt-0">
      <div className="container mx-auto px-4 md:px-6 relative group">
        ...
        <div
          ref={scrollRef}
          className="flex items-center md:justify-center gap-10 md:gap-16 overflow-x-auto no-scrollbar scroll-smooth pt-7 pb-3 md:pt-8 md:pb-2 px-1"
        >
