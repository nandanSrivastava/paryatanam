...
export function FeaturedTours() {
  ...
  // submission handled inside CallbackModal
  return (
    <>
      <section
                  ...
                  <div className="p-5 sm:p-6 md:p-7">
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="inline-flex items-center justify-center rounded-full border-primary/30 text-primary hover:bg-primary hover:text-white transition-all duration-300 flex-shrink-0 h-10 w-10 p-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 outline-1"
                      >
