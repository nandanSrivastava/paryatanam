                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-white/80 text-sm leading-relaxed max-w-xs">
                            Your trusted partner in exploring the world. We craft unforgettable journeys that inspire and rejuvenate.
                        </p>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="font-serif text-lg font-bold mb-4 text-secondary">Discover</h3>
                        <ul className="space-y-2">
                            {["About Us", "Our Team", "Careers", "Travel Guides", "Blog"].map((item) => (
                                <li key={item}>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3 text-white/80 text-sm">
                                ...
                                <span>123 Adventure Lane, Wanderlust City, WL 56789</span>
                            </li>
                            ...
                            <li className="flex items-center gap-3 text-white/80 text-sm">
                                ...
                                <span>hello@paryatanam.com</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    {/* Newsletter */}
                    <div>
                        <h3 className="font-serif text-lg font-bold mb-4 text-secondary">Newsletter</h3>
