  ...
  return (
    <>
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 grid-rows-2 gap-2 sm:gap-3 h-[300px] xs:h-[350px] sm:h-[400px] md:h-[550px] rounded-2xl sm:rounded-3xl overflow-hidden shadow-luxury">
        ...
        <div 
          className="col-span-2 row-span-2 md:col-span-2 md:row-span-2 relative group cursor-pointer overflow-hidden touch-manipulation"
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-60 sm:group-hover:opacity-20 transition-opacity duration-500" />
          <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 bg-white/95 backdrop-blur-sm px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-primary font-bold text-xs sm:text-sm shadow-lg opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity duration-300 flex items-center gap-2">
            View Full Gallery
          </div>
        </div>
        ...
        {images.slice(1, 5).map((img, index) => (
          ...
          >
            <img
              ...
              className="object-cover w-full h-full transition-transform duration-700 group-hover:scale-110 group-active:scale-105"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent sm:group-hover:opacity-0 transition-opacity duration-300" />
