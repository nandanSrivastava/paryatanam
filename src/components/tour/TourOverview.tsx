    ...
    <div className="bg-white rounded-3xl p-8 md:p-10 shadow-luxury border border-neutral-100 hover:shadow-2xl transition-shadow duration-500">
      ...
      <ul className="grid grid-cols-1 gap-5 mb-10">
        {tour.highlights.map((highlight: string, index: number) => (
          ...
          >
            <div className="mt-0.5 min-w-7 h-7 rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 text-white flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
