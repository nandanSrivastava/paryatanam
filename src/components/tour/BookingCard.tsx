...
interface BookingCardProps {
    tour: any; // Type strictly in real app
}
        ...
        <div className="bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
            ...
            <div className="p-6 bg-[#0B3D2E] text-white">
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-gray-300 line-through text-sm">₹{tour.originalPrice.toLocaleString()}</span>
                </div>
                ...
                <p className="text-xs text-gray-300 mt-2">*Excluding taxes & fees</p>
            </div>
            ...
            <div className="p-6 space-y-6">
                {/* Date Selector */}
                <div>
                    <label className="block text-xs font-bold uppercase text-gray-500 mb-2">Select Travel Date</label>
                ...
                {/* Guest Selector */}
                <div>
                    <label className="block text-xs font-bold uppercase text-gray-500 mb-2">Travelers</label>
                    <div className="border border-gray-200 rounded-lg p-3 flex items-center gap-3 cursor-pointer hover:border-primary transition-colors">
                ...
                {/* Action Button */}
                <Button size="lg" className="w-full bg-secondary hover:bg-secondary/90 text-primary font-bold text-lg h-14">
                    Send Enquiry
                </Button>
